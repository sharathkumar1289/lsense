    ...
    <section className="container mx-auto px-5 md:px-16" id="features">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 md:gap-5 text-center mt-10 md:mt-20">
        <FeatureProduct
          ...
          desc="Unlock Insights Beyond Imagination
          Leverage the full potential of your data with our advanced analytics solutions. Transform raw data into actionable insights using Power BI, empowering your business decisions with unparalleled precision."
        />
        <FeatureProduct
