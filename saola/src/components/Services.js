...
const Services = () => {
    ...
    return (
        ...
        <div id="services" className="bg-gray-100 py-12" style={{paddingTop:80}} >
                    ...
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                ...
                                Embark on a journey of technological transformation with Saola, where our passion for the latest IT trends and solutions drives us. Though new to the scene, our team brings a fresh perspective to software analysis and design. We're committed to providing tailored recommendations and strategies that enhance your operations, streamline costs, and boost efficiency. Let us help you navigate the evolving digital landscape with cutting-edge, efficient solutions.    </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            <div className='text-blue-900 mb-4'>
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>At Saola, we specialize in collaborating with your existing tech team to elevate and scale your software applications. Our expertise lies in designing customized software solutions tailored to fit your everyday needs, streamlining and simplifying various processes. Partner with us to transform your technology landscape, enhancing efficiency and driving innovation in every step of your business journey.</p>
                            </div>
                        </div>
                    </div>
                </div>
